...
class LessonTest(APITestCase):
    ...
    def test_create_lesson(self):
        ...
        self.data = {"title": "Test", "description": "Test", "course": self.course.id}
        ...
        self.assertTrue(Lessons.objects.all().exists())
    ...
    def test_delete_lesson(self):
        ...
        self.assertFalse(Lessons.objects.filter(id=lesson.id).exists())
